...
- `Cursewords-Portable-0.4.3-x64.exe`
- `Cursewords-Setup-0.4.3-x64.exe`
- `win-unpacked/`
...
- `Cursewords-0.4.3-x64.dmg`
- `Cursewords-0.4.3-arm64.dmg`
- `Cursewords-0.4.3-x64.zip`
- `Cursewords-0.4.3-arm64.zip`
- `latest-mac.yml`
